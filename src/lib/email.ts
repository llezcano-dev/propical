      ...
      <tr><td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:440px;background:#ffffff;border-radius:14px;border:1px solid #e7e5e4;overflow:hidden;">
          <tr><td style="padding:28px 32px 8px;">
            ...
            <div style="font-size:15px;font-weight:600;color:#1c1917;letter-spacing:-0.01em;">propical</div>
          </td></tr>
...
export async function sendVerificationCodeEmail(
  ...
  return sendEmail({
    to,
    subject: `${code} is your Propical verification code`,
    html: codeEmailHtml(
      "Confirm your email",
      "Enter this code on the sign-up page to finish creating your Propical account.",
      code,
      "This code expires in 15 minutes. If you didn't request it, you can ignore this email.",
    ),
    text:
      `Your Propical verification code is ${code}\n\n` +
...
export async function sendPasswordResetEmail(
  ...
  return sendEmail({
    to,
    subject: `${code} is your Propical password reset code`,
    html: codeEmailHtml(
      "Reset your password",
    ...
    text:
      `Your Propical password reset code is ${code}\n\n` +
