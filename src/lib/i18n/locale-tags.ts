...
/**
 * Mapping from our internal locale code (`Locale` union, e.g. "en", "pt")
 ...
 * filled in — no scattered ternaries silently falling back to English.
 */
 ...
 * `en-GB` because we're EU-targeting day-month order.
 */
