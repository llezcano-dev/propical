...
export function AnnouncementBanner() {
  ...
  return (
    <div
      role="status"
      className="cls-isolate animate-slide-down flex items-start justify-between gap-4 border-b border-border-strong bg-blue-500/10 px-4 py-2 text-sm text-text-secondary"
    >
