...
const ONBOARD_COPY: Record<Locale, { title: string; description: string }> = {
  ...
  pt: {
    title: "Começar — sincronize seus calendários em 30 segundos",
    description:
      "Cole as URLs dos calendários do Airbnb e Booking.com, receba suas URLs de feed de sincronização e salve em uma conta gratuita. Não é preciso se cadastrar para testar.",
  },
  es: {
