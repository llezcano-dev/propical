...
// Brand typography (brand book v1.1):
//   DM Sans = corpo (body, captions, UI text)
//   DM Mono = display/títulos + datos (eyebrows, values, codes)
...
export default async function RootLayout({
  ...
  return (
    <html
      ...
      className={`${dmSans.variable} ${dmMono.variable} h-full antialiased ${initialTheme === "dark" ? "dark" : ""}`}
