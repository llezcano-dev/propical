...
// AuditLog has no FK by design (audit history generally outlives user
// deletion) — we wipe it here because the user is asking us to forget
// them. Sessions are cleared on the way out so the next request kicks
// them to /login.
