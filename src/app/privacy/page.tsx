...
const PRIVACY_DESCRIPTION =
  "How Propical collects, uses, stores, and protects your data — and how to access, export, or delete it.";
    ...
    <div className="editorial min-h-screen bg-surface text-text-primary">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-text-secondary sm:text-base">
          <section>
            <p>
              This Privacy Policy describes how Propical (&quot;the Service&quot;,
          ...
          <section>
            ...
            <p className="mt-2 font-mono text-text-primary">{OPERATOR_EMAIL}</p>
            <p className="mt-2">
          ...
          <section>
            <h2 className="mb-2 text-lg font-semibold text-text-primary">2. What data we collect</h2>
            <p>We collect only the minimum necessary to operate the Service.</p>
            <p className="mt-3 font-medium text-text-primary">(a) Account data</p>
            <p>
            ...
            <p className="mt-3 font-medium text-text-primary">(b) Service data you create</p>
            <p>
            ...
            <p className="mt-3 font-medium text-text-primary">(c) Operational data</p>
            <p>
            ...
            <p className="mt-3 font-medium text-text-primary">(d) Guest passport data (you provide)</p>
            <p>
              Guest passport details (full name, document number, country, document
              type, expiry date) are entered by you — manually or via your guest&apos;s
              pre-arrival form submission — and stored in your account only. We do
              not process passport images.
            </p>
          </section>

          <section>
            <h2 className="mb-2 text-lg font-semibold text-text-primary">3. How we use your data and the legal basis</h2>
            <ul className="list-disc space-y-2 pl-5">
              <li>
                <span className="font-medium text-text-primary">Performance of contract</span>{" "}
              ...
              <li>
                <span className="font-medium text-text-primary">Legitimate interests</span>{" "}
              ...
              <li>
                <span className="font-medium text-text-primary">Legal obligation</span>{" "}
                (Art. 6(1)(c) GDPR): retaining data as required to respond to lawful
                requests from authorities.
              </li>
              <li>
                <span className="font-medium text-text-primary">For guest passports you upload</span>:
          ...
          <section>
            <h2 className="mb-2 text-lg font-semibold text-text-primary">4. Sub-processors and third parties</h2>
            ...
            <ul className="list-disc space-y-2 pl-5 mt-2">
              <li>
                ...
                hosts the application server (serverless functions). Acts
                as a hosting sub-processor.{" "}
                <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-sky-400 hover:underline">
                  Privacy policy
                </a>.
              </li>
              <li>
                <span className="font-medium text-text-primary">Turso (ChiselStrike, Inc.)</span> —
                hosts the application database (libSQL cloud). Stores all
                application data including user accounts, properties, reservations,
                and guest information.{" "}
                <a href="https://turso.tech/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-sky-400 hover:underline">
                  Privacy policy
                </a>.
              </li>
              <li>
                <span className="font-medium text-text-primary">Functional Software, Inc. (Sentry)</span> —
              ...
              <li>
                <span className="font-medium text-text-primary">Better Stack s.r.o. (BetterStack)</span> —
              ...
              <li>
                <span className="font-medium text-text-primary">Airbnb &amp; Booking.com</span>{" "}
          ...
          <section>
            <h2 className="mb-2 text-lg font-semibold text-text-primary">5. International data transfers</h2>
            <p>
              The application server is in the European Union. Sentry,
              Vercel, and Turso may involve data transfers to
          ...
          <section>
            <h2 className="mb-2 text-lg font-semibold text-text-primary">6. Where data lives and how long we keep it</h2>
            <ul className="list-disc space-y-2 pl-5">
              <li>
          ...
          <section>
            <h2 className="mb-2 text-lg font-semibold text-text-primary">8. Your rights</h2>
            <p>
            ...
            <ul className="list-disc space-y-2 pl-5 mt-2">
              <li>
                <span className="font-medium text-text-primary">Access</span> the personal
                data we hold about you. Use Profile → Export my data for a JSON dump of
                your full account.
              </li>
              <li>
                <span className="font-medium text-text-primary">Rectify</span> inaccurate
                data — every field is editable in-app.
              </li>
              <li>
                <span className="font-medium text-text-primary">Erase</span> your data
              ...
              <li>
                <span className="font-medium text-text-primary">Port</span> your data to
                another service — the Reports panel exports reservations as CSV, and the
                full export above is JSON.
              </li>
              <li>
                <span className="font-medium text-text-primary">Restrict</span> or
                <span className="font-medium text-text-primary"> object</span> to processing
              ...
              <li>
                <span className="font-medium text-text-primary">Withdraw consent</span>{" "}
                where consent is the legal basis (e.g. when you have asked us to email
                you about service changes — currently we don&apos;t).
              </li>
              <li>
                <span className="font-medium text-text-primary">Lodge a complaint</span>{" "}
          ...
          <section>
            <h2 className="mb-2 text-lg font-semibold text-text-primary">9. Security</h2>
            <p>
              We protect your data with TLS 1.2+ in transit (managed by
              Vercel with automatic certificate renewal), bcrypt password
              hashing at rest, JWT-based session authentication with HTTP-only cookies,
              IP-based rate limiting on auth endpoints, and
              brute-force protection on login endpoints. No system is 100% secure;
          ...
          <section>
            <h2 className="mb-2 text-lg font-semibold text-text-primary">10. Guest passport data — your responsibility</h2>
            <p>
              When you upload guest passports to Propical you remain the data controller
          ...
          <section>
            <h2 className="mb-2 text-lg font-semibold text-text-primary">11. Children</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-semibold text-text-primary">12. Automated decision-making</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-semibold text-text-primary">14. Contact</h2>
            <p>
