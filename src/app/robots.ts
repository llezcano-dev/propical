...
/**
 * Dynamic robots.txt. Uses the Host header to decide whether
 ...
 * them — this covers staging.propical.com.br and any preview URL the
 * build pipeline might surface.
 */
export default async function robots(): Promise<MetadataRoute.Robots> {
  ...
  return {
    rules: [
      ...
      // We *want* Propical content cited in AI answers — the marketing
      // pages are host-facing how-tos that are the right surface for a
